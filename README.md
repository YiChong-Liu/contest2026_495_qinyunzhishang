...
基于 OpenVela OS（NuttX RTOS）与 BES2800 BP 芯片打造的端云协同轻量化 AI 办公终端：以 AI 语音对话为核心交互，深度集成飞书生态，覆盖办公信息从采集、处理到归档的全流程自动化。本作品由华勤技术软件中心三部自主立项开发，作为 2026 首届 OpenVela AI 硬件开发者大赛参赛作品（队伍「勤云之上」，编号 495），是部门的AI自研项目。
