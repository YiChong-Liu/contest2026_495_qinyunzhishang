...
/* Return the number of bytes pending in the ring buffer (not yet
 * consumed by the drain thread).  Useful for flow control between
 * segmented TTS writes to avoid overfilling the ring buffer. */
