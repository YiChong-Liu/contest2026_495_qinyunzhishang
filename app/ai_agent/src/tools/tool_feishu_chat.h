...
/**
 * Tool: list today's messages from all Feishu chats the bot joined.
 * Uses tenant_access_token (bot identity), only sees chats the bot is in.
 * Input: {} (no parameters)
 * Output: plain-text grouped by chat, e.g.:
 *   "=== 群聊: 项目群 ===\n[09:30] 今天开会\n[09:35] 收到\n..."
 * Returns "No messages today" if no messages found.
 */
